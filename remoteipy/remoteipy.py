...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/remoteipy.ipynb.

# %% auto 0
__all__ = ['connected_clients', 'Client', 'connect', 'run_remote_blocking', 'disconnect']

# %% ../nbs/remoteipy.ipynb 1
#| export
#| default_exp remoteipy

# %% ../nbs/remoteipy.ipynb 3
import subprocess
import json
...
# %% ../nbs/remoteipy.ipynb 5
connected_clients = {}

# %% ../nbs/remoteipy.ipynb 7
def connect(
    user:str,
    host:str,
    port:int,
